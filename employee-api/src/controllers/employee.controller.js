...
exports.createEmployee = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({
      message: "err for create employee"
    });
  }
};
...
exports.listAllEmployees = async (req, res) => {
  try {
    ...
    res.status(500).send({
      message: "err for list all employees"
    });
  }
};
...
exports.updateEmployeeById = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({
      message: "err for update emplloyee"
    });
  }
};
